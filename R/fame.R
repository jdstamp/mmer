...
#' @import RcppEigen
#' @export
fame <- function(plink_file, pheno_file, annotation_file, covariate_file, n_randvecs, focal_snp_index, n_blocks) {
  result <- fame_cpp(plink_file, pheno_file, annotation_file, covariate_file, n_randvecs, focal_snp_index, n_blocks)
  return(result)
}
