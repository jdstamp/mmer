...
Cartoon illustrating the effect of applying appropriate masks to the marginal epistasis test. Masking not only results improved power to detect variants of small phenotypic variance explained over the full data, but also in faster runtime.
