...
RcppExport SEXP _famer_fame_cpp(SEXP plink_fileSEXP, SEXP pheno_fileSEXP,
                                SEXP covariate_fileSEXP, SEXP n_randvecsSEXP,
                                SEXP focal_snp_indexSEXP, SEXP n_blocksSEXP,
                                SEXP rand_seedSEXP) {
  BEGIN_RCPP
  ...
  Rcpp::traits::input_parameter<std::string>::type covariate_file(
      covariate_fileSEXP);
  ...
  rcpp_result_gen =
      Rcpp::wrap(fame_cpp(plink_file, pheno_file, covariate_file, n_randvecs,
