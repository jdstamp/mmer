...
public:
  ...
  void read_plink(std::istream &stream, std::string filenameprefix,
                  bool allow_missing, bool mailman_mode);
  void read_bed(std::istream &stream, std::string filename, bool allow_missing,
                bool mailman_mode);
  ...
  void read_bed_mailman(std::istream &stream, std::string filename,
                        bool allow_missing);
